<?php
/**
 * Research Areas Archive Template
 * 
 * Logic:
 * 1. High contrast legibility standards (WCAG 4.5:1+).
 * 2. Elimination of layout drifting and rogue absolute elements.
 */
get_header();
?>
...
<section class="page-hero high-contrast-technical-hero">
    <div class="container hero-technical-grid">
        <div class="hero-text-block">
            <p class="eyebrow McGill-white-accent"><?php esc_html_e( 'Research Philosophy', 'shmuel-lab' ); ?></p>
    ...
    <div class="container">
        <div class="map-inner-wrap high-contrast-border">
            <div class="section-kicker">
                <p class="eyebrow McGill-white-accent"><?php esc_html_e( 'Investigation Workflow', 'shmuel-lab' ); ?></p>
